...
def get_pricing_advice(user_input):
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are Dr. Pricing, a pricing strategy expert. You keep a low-key profile and avoid using phrases like "As Dr. Pricing". Help businesses adjust prices based on market conditions, competitor moves, cost shocks, and demand changes."},
